...
eventForm.addEventListener("submit", async (e) => {
  ...
  try {
    // 1. Save the event in Firestore so the dashboard has a record of it.
    ...
    // 2. Trigger the n8n automation. NOTE: this fetch will fail until
    ...
    // Photo upload isn't wired up yet (needs Firebase Storage + a bucket
    // rule) — add that once the Higgsfield/Claude nodes are confirmed working.
    try {
